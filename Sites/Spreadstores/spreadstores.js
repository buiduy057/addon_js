...
if (window.location.href.indexOf("https://xx.com") > -1) {
  ...
  window.location.href.indexOf("https://www.spreadstores.com") > -1 ||
  window.location.href.indexOf("https://spreadstores.com") > -1
) {
          ...
          for (const path of urlsUnique) {
            try {
              ...
              const title = $(bodyPath)
                .find(".entry-summary  h1.product-title ")
                .text();
              ...
              $(imageitem).each(function (_, item) {
                ...
                const ItemN = Item.replace("-300x300", "");
                ...
                $(itemSelect).each(function (_, item) {
                  ...
                  if (countFor === 0) {
                    if (Item.indexOf("style") > -1) {
                      optionName[`option${j}_name`] = OptionSeName(
                        $(item).attr("id")
                      );
                      j += 1;
                    }
                        ...
                        await fetch(
                          ...
                          .then((data) => {
                            ...
                            if (dataI !== false) {
                              const itemVariant = {
                                sku: dataI.sku,
                                option1: OptionSeName(item.option),
                                option2: item02.option.toUpperCase(),
                                option2: item03.option.toUpperCase(),
                                var_images: CheckImgSe(dataI.image.full_src),
                    ...
                    for (const option in dataVariants[0].attributes) {
                      if (countFor === 0) {
                        if (option.indexOf("style") > -1) {
                          itemVariant[`option${l}`] = OptionSeName(
              ...
              product["gender"] = "All";
              product["vender"] = `outdoorpod_spreadstores`;
              product["vender_url"] = path;
              product["description"] = description;
              product["images"] =
                imageThub !== undefined ? imageThub : images_arr;
              ...
              send(product, `outdoorpod_spreadstores`);
              // break;
            } catch (e) {
              console.error(e);
            } finally {
