...
if (window.location.href.indexOf("https://xx.com") > -1) {
  ...
  window.location.href.indexOf("https://www.tidefam.store") > -1 ||
  window.location.href.indexOf("https://tidefam.store") > -1
) {
          ...
          for (const path of urlsUnique) {
            try {
              ...
              if (test.length > 1) {
                ...
                for (const item_1 of arr_1) {
                  const itemVariant = {
                    option1: item_1[1] !== undefined ? item_1[1] : item_1[0],
                    price:
                      item_1[1] !== undefined
                        ? Number(item_1[0]) - 2
                        : price - 2,
