...
if (window.location.href.indexOf("https://xx.com") > -1) {
  ...
  window.location.href.indexOf("https://www.shieldrepublic.com") > -1 ||
  window.location.href.indexOf("https://shieldrepublic.com") > -1
) {
  $(window).ready(function () {
    ...
    async function getPage(page = 1) {
      try {
        ...
        const productItem = $(body).find("#AjaxinateLoop .productgrid a");
        ...
        for (const path of urlsUnique) {
          try {
            // console.log(path);
            const urlProduct = `https://www.shieldrepublic.com/${path}`;
            ...
            const option3_name = data.options[2].name;
            let variants_arr = [];
