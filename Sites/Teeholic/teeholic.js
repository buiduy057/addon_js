...
if (window.location.href.indexOf("https://xx.com") > -1) {
  ...
  window.location.href.indexOf("https://www.teeholic.com") > -1 ||
  window.location.href.indexOf("https://teeholic.com") > -1
) {
  $(window).ready(function () {
    ...
    async function getPage(page = 1) {
      try {
        ...
        const productItem = $(body).find(".products .product .image a");
        ...
        for (const path of urlsUnique) {
          try {
            ...
            if (title.indexOf("Mug") !== -1) {
              ...
              send(product, "teeholic");
            } else if (title.indexOf("Face Mask") !== -1) {
              let images = data.images;
              let tags = data.tags.toString();
              const option1_name = data.options[0].name;
              const option2_name = data.options[1].name;
