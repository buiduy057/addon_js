...
if (window.location.href.indexOf("https://xx.com") > -1) {
  ...
  window.location.href.indexOf("https://www.waywarrior.com") > -1 ||
  window.location.href.indexOf("https://waywarrior.com") > -1
) {
        ...
        try {
          ...
          for (const path of urlsUnique) {
            try {
              ...
              await fetch(
                "https://www.waywarrior.com/wp-admin/admin-ajax.php",
                {
                  method: "POST",
                  body: formData,
                }
