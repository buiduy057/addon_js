...
if (window.location.href.indexOf("https://xx.com") > -1) {
  ...
  window.location.href.indexOf("https://www.crislux.com") > -1 ||
  window.location.href.indexOf("https://crislux") > -1
) {
    ...
    $(window).ready(function () {
      ...
      async function getPage(page = 1) {
        try {
          ...
          const productItem = $(body).find(".shop-container .product-small a");
          ...
          for (const path of urlsUnique) {
            try {
              ...
              const title = $(bodyPath)
                .find(".product-title-container h1.product-title ")
                .text();

              const description = $(bodyPath)
                .find(".product-page-accordian")
                .html();
              let imageThub = [];
