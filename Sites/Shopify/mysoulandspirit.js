...
if (window.location.href.indexOf("https://xx.com") > -1) {
  ...
  window.location.href.indexOf("https://www.mysoulandspirit.com") > -1 ||
  window.location.href.indexOf("https://mysoulandspirit.com") > -1
) {
  if (
    window.location.href.indexOf("https://mysoulandspirit.com/#MainContent") >
    -1
  ) {
    window.close();
    ...
    $(window).ready(function () {
      ...
      setTimeout(function () {
        console.log($(".card .product-list .product-item"));
        if ($(".card .product-list .product-item").length == 0) {
          return;
        } else {
          $(".card .product-list .product-item").each(function (key, item) {
            setTimeout(function () {
              console.log(key);
              get_shirt99(key, item);

              if (key == $(".card .product-list .product-item").length - 1) {
                setTimeout(function () {
                  var url_string = window.location.href;
                  var page = get("page");
            ...
            function get_shirt99(key, item) {
              var url = "https://mysoulandspirit.com/";
