...
if (window.location.href.indexOf("https://xx.com") > -1) {
  ...
  window.location.href.indexOf("https://www.herashine..com") > -1 ||
  window.location.href.indexOf("https://herashine.com") > -1
) {
      ...
      async function getPage(page = 1) {
        try {
          ...
          const productItem = $(body).find(
            ".shop-container .products .image-zoom a"
          );
